...
// how tp remove the - from the name and replace it with a space:
const  {name}  = router.currentRoute.value.params;
onBeforeMount(async () => {
  if (useCompanyStore().getCompanies.length == 0){
    await useCompanyStore().fetchCompanies();
  }
});
console.log(name.replace(/-/g," "));
const company = useCompanyStore().getCompanies.find((company) => company.name == name.replace(/-/g, " "));
</script>
<template>
 <main id="main">
    ...
    <div class="row">
      ...
      <div class="col-lg-8 entries">
        ...
        <div class="blog-comments">
          ...
          <h4 class="comments-count">8 Reviews</h4>
